...
export { isInShell, initShellBridge, shellNavigate, shellNavigateExternal, shellSetTitle, shellSetSidebarState, onShellMessage, getShellInitData, safeCookieGet, safeCookieSet, installShellLinkInterceptor, installShellNavigationSync, installShellClipboardProxy, authenticatedUrl, shellClipboardWrite } from './lib/shell-bridge'
